    ...
    <div class="container">
        ...
        <?php if ($selected_showtime): ?>
            <div class="movie-info">
                ...
                <p><i class="fas fa-clock"></i> <strong>Thời lượng:</strong> <?php echo $selected_showtime['duration']; ?></p>
                <p><i class="fas fa-map-marker-alt"></i> <strong>Rạp:</strong> <?php echo $selected_showtime['cinema_name']; ?></p>
                <p><i class="fas fa-calendar"></i> <strong>Ngày chiếu:</strong> <?php echo date('d/m/Y', strtotime($selected_showtime['show_date'])); ?></p>
                <p><i class="fas fa-clock"></i> <strong>Giờ chiếu:</strong> <?php echo date('H:i', strtotime($selected_showtime['show_time'])); ?></p>
            </div>
                        ...
                        <div class="showtimes-grid">
                            <?php foreach ($available_showtimes as $showtime): ?>
                                <div class="showtime-card" data-showtime-id="<?php echo $showtime['id']; ?>">
                                    ...
                                    <div>
                                        <i class="fas fa-calendar"></i> <?php echo date('d/m/Y', strtotime($showtime['show_date'])); ?>
                                    </div>
                                    <div>
                                        <i class="fas fa-clock"></i> <?php echo date('H:i', strtotime($showtime['show_time'])); ?>
                                    </div>
                                    <div>
                                        <i class="fas fa-chair"></i> Còn <?php echo $showtime['available_seats']; ?>/<?php echo $showtime['total_seats']; ?> ghế
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
